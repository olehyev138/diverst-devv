...
module Clockwork
    ...
    every(1.day, 'Send daily notifications of pending users to group leaders', at: '00:00'){ Group.where(:pending_users => "enabled").find_each { |group| GroupLeaderMemberNotificationsJob.perform_later(group.id) } }
    ...
    every(1.day, 'Archive expired new', at: '00:00') { NewsFeedLink.archive_expired_news }

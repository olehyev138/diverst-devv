    ...
    context 'when manage_all is false' do
      context 'index?' do
        ...
        context 'when group.members_visibility is set to group' do
          ...
          context 'when groups_manage and group_leader_manage are true' do
            before { user.policy_group.update groups_manage: true, group_leader_manage: true }
          ...
          context 'user is member and group_leader_manage is true : is_a_member' do
            before do

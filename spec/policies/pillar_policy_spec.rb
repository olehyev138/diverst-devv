...
RSpec.describe PillarPolicy, type: :policy do
  ...
  describe 'for users with access' do
    ...
    context 'when manage_all is true' do
      ...
      context 'when initiatives_manage, groups_manage and initiatives_create are false' do
        before { user.policy_group.update initiatives_manage: false, groups_manage: false, initiatives_create: false }

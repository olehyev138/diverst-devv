...
RSpec.describe MentorMailer, type: :mailer do
  ...
  describe '#session_updated' do
    ...
    it 'renders the subject' do
      expect(mail.subject).to eq "Mentoring Session Scheduled for #{mentoring_session.start.strftime("%m/%d/%Y %I:%M %p")} has been updated"
    end
  ...
  describe '#session_canceled' do
    ...
    it 'renders the subject' do
      expect(mail.subject).to eq "Mentoring Session Scheduled for #{mentoring_session.start.strftime("%m/%d/%Y %I:%M %p")} has been canceled"
    end

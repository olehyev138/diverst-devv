...
RSpec.describe CampaignSerializer, type: :serializer do
  it 'returns fields for campaign' do
    campaign = create(:campaign, image: { io: File.open('spec/fixtures/files/verizon_logo.png'), filename: 'file.png' }, banner: { io: File.open('spec/fixtures/files/verizon_logo.png'), filename: 'file.png' })

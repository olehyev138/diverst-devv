...
RSpec.describe GroupCategoriesController, type: :controller do
	...
	let!(:group_category1) { create(:group_category, name: "category 1", enterprise_id: enterprise.id) } 
	let!(:group_category2) { create(:group_category, name: "category 2", enterprise_id: enterprise.id) } 

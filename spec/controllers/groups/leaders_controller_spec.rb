    ...
    context 'with logged in user' do
      ...
      context 'with correct params' do
        ...
        context 'when more than one group_leader object is set as group contact' do
          let!(:another_group_leader) { create(:group_leader, group: group, group_contact: true) }
          let!(:leader_attrs) { attributes_for :group_leader, user_id: leader_user.to_param, group_contact: true }

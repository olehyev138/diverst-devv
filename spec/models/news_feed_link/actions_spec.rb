...
RSpec.describe NewsFeedLink::Actions, type: :model do
  describe 'valid_scopes' do
    let!(:valid_scopes) { %w(approved pending combined_news_links not_archived archived pinned not_pinned) }
  ...
  describe 'base_left_joins' do
    let!(:base_left_joins) { [:group_message, :news_link, :social_link] }

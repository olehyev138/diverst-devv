...
describe('Get Events Saga', () => {
  ...
  it('Should return error from the API', async () => {
    ...
    expect(dispatched).toEqual(results);
    expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.load_events, options: { variant: 'warning' } });
  });
});
...
describe('Create event', () => {
  ...
  it('Should return error from the API', async () => {
    ...
    expect(dispatched).toEqual(results);
    expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.create_event, options: { variant: 'warning' } });
  });
});
...
describe('Update event', () => {
  ...
  it('Should return error from the API', async () => {
    ...
    expect(dispatched).toEqual(results);
    expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.update_event, options: { variant: 'warning' } });
  });
});
...
describe('Delete event', () => {
  ...
  it('Should return error from the API', async () => {
    ...
    expect(dispatched).toEqual(results);
    expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.delete_event, options: { variant: 'warning' } });
  });
});
...
describe('Delete comment', () => {
  ...
  it('Should return error from the API', async () => {
    ...
    expect(dispatched).toEqual(results);
    expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.delete_event_comment, options: { variant: 'warning' } });
  });
});
...
describe('Create comment', () => {
  ...
  it('Should return error from the API', async () => {
    ...
    expect(dispatched).toEqual(results);
    expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.create_event_comment, options: { variant: 'warning' } });
  });
});
...
describe('Join event', () => {
  ...
  it('Should return error from the API', async () => {
    ...
    expect(dispatched).toEqual(results);
    expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.join, options: { variant: 'warning' } });
  });
});
...
describe('Leave event', () => {
  ...
  it('Should return error from the API', async () => {
    ...
    expect(dispatched).toEqual(results);
    expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.leave, options: { variant: 'warning' } });
  });
});
// TODO
describe('finalize expenses', () => {
  ...
  xit('Should return error from the API', async () => {
    ...
    expect(dispatched).toEqual(results);
    expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.finalize_expense, options: { variant: 'warning' } });
  });
});
...
describe('Export event attendees', () => {
  ...
  xit('Should return error from the API', async () => {
    ...
    expect(api.initiativeUsers.leave).toHaveBeenCalledWith({ initiative_user: undefined });
    expect(dispatched).toEqual(results);
    expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.export_attendees, options: { variant: 'warning' } });
  });
});

...
export function* getGroupCategories(action) {
  try {
    ...
    yield put(showSnackbar({ message: messages.snackbars.errors.categories, options: { variant: 'warning' } }));
  }
}
...
export function* getGroupCategory(action) {
  try {
    ...
    yield put(showSnackbar({ message: messages.snackbars.errors.category, options: { variant: 'warning' } }));
  }
}

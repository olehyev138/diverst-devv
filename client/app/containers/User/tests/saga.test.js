...
describe('saga tests for users', () => {
  describe('Get users Saga', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.users.all).toHaveBeenCalledWith(initialAction.payload);
      expect(dispatched).toEqual(results);
      expect(showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.users, options: { variant: 'warning' } });
    });
  });
  ...
  describe('Get user Saga', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.users.get).toHaveBeenCalledWith(initialAction.payload.id);
      expect(dispatched).toEqual(results);
      expect(showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.user, options: { variant: 'warning' } });
    });
  });
  ...
  describe('Get user prototype', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.users.prototype).toHaveBeenCalledWith(initialAction.payload);
      expect(dispatched).toEqual(results);
      expect(showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.prototype, options: { variant: 'warning' } });
    });
  });
  ...
  describe('Get user download data', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.user.getDownloadData).toHaveBeenCalledWith(initialAction.payload);
      expect(dispatched).toEqual(results);
      expect(showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.user_data, options: { variant: 'warning' } });
    });
  });
  ...
  describe('Get user posts', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.user.getPosts).toHaveBeenCalledWith(initialAction.payload);
      expect(dispatched).toEqual(results);
      expect(showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.posts, options: { variant: 'warning' } });
    });
  });
  ...
  describe('Get user events', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(dispatched).toEqual(results);
      expect(showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.events, options: { variant: 'warning' } });
    });
  });
  ...
  describe('should update field data', () => {
    it('Should update the field data', async () => {
      ...
      expect(dispatched).toEqual(results);
      expect(showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.success.fields, options: { variant: 'warning' } });
    });
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.fieldData.updateFieldData).toHaveBeenCalledWith({ field_data: { field_data: {} } });
      expect(dispatched).toEqual(results);
      expect(showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.fields, options: { variant: 'warning' } });
    });
  });
});

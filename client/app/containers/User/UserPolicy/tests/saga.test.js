...
describe('tests for policy saga', () => {
  describe('Get policies Saga', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.policyTemplates.all).toHaveBeenCalledWith(initialAction.payload);
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.policies, options: { variant: 'warning' } });
    });
  });
  ...
  describe('Get policy Saga', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.policyTemplates.get).toHaveBeenCalledWith(initialAction.payload.id);
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.policy, options: { variant: 'warning' } });
    });
  });

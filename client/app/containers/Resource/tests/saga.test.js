...
describe('Tests for folders', () => {
  describe('Get folders Saga', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.folders.all).toHaveBeenCalledWith(initialAction.payload);
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.folders, options: { variant: 'warning' } });
    });
  });
  ...
  describe('Get folders Saga', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.folders.get).toHaveBeenCalledWith(initialAction.payload.id);
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.folder, options: { variant: 'warning' } });
    });
  });
  ...
  describe('Create folder', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.create_folder, options: { variant: 'warning' } });
    });
  });
  ...
  describe('update folder', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.folders.update).toHaveBeenCalledWith(initialAction.payload.id, { folder: initialAction.payload });
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.update_folder, options: { variant: 'warning' } });
    });
  });
  ...
  describe('Delete folder', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.folders.destroy).toHaveBeenCalledWith(initialAction.payload.id);
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.delete_folder, options: { variant: 'warning' } });
    });
  });
  ...
  describe('Validate password for a folder', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.folders.validatePassword).toHaveBeenCalledWith(initialAction.payload);
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.password, options: { variant: 'warning' } });
    });
  });
});
...
describe('Tests for resources', () => {
  describe('Get resources Saga', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.resources.all).toHaveBeenCalledWith(initialAction.payload);
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.resources, options: { variant: 'warning' } });
    });
  });
  ...
  describe('Get resource Saga', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.resources.get).toHaveBeenCalledWith(initialAction.payload.id);
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.resource, options: { variant: 'warning' } });
    });
  });
  ...
  describe('Create resource', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.create_resource, options: { variant: 'warning' } });
    });
  });
  ...
  describe('update resource', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.resources.update).toHaveBeenCalledWith(initialAction.payload.id, { resource: initialAction.payload });
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.update_resource, options: { variant: 'warning' } });
    });
  });
  ...
  describe('Delete resource', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.resources.destroy).toHaveBeenCalledWith(initialAction.payload.id);
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.delete_resource, options: { variant: 'warning' } });
    });
  });
  ...
  describe('getResource file data', () => {
    ...
    it('Should return error from the API', async () => {
      ...
      expect(api.resources.getFileData).toHaveBeenCalledWith(initialAction.payload);
      expect(dispatched).toEqual(results);
      expect(Notifiers.showSnackbar).toHaveBeenCalledWith({ message: messages.snackbars.errors.file_data, options: { variant: 'warning' } });
    });
  });
});

...
import {
  ...
  CampaignQuestionListPage, EnterpriseConfigurationPage,
...
export default function Routes(props) {
  ...
  return (
    <Switch>
      ...
      <AdminLayout {...expandRoute(ROUTES.admin.innovate.campaigns.questions.index)} component={CampaignQuestionListPage} />

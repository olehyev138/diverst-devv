...
export function EnterpriseExportGenericGraphsMentoringSessions(props) {
...
EnterpriseExportGenericGraphsMentoringSessions.propTypes = {
  activity: PropTypes.object,
};

export default compose(
  memo,
)(EnterpriseExportGenericGraphsMentoringSessions);

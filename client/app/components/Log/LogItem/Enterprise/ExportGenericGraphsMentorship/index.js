...
export function EnterpriseExportGenericGraphsMentorship(props) {
  ...
  return (
    <React.Fragment>
      ...
      {' exported mentorship graph via CSV '}
      {' at '}
...
EnterpriseExportGenericGraphsMentorship.propTypes = {
  activity: PropTypes.object,
};

export default compose(
  memo,
)(EnterpriseExportGenericGraphsMentorship);

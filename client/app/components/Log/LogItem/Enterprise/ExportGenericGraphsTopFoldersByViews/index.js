...
export function EnterpriseExportGenericGraphsTopFoldersByViews(props) {
  ...
  return (
    <Box display='flex' alignItems='center' width='auto'>
      ...
      <Box order={2}>
        {' exported top folders by views graph via CSV '}
        {' at '}
...
EnterpriseExportGenericGraphsTopFoldersByViews.propTypes = {
  activity: PropTypes.object,
};

export default compose(
  memo,
)(EnterpriseExportGenericGraphsTopFoldersByViews);

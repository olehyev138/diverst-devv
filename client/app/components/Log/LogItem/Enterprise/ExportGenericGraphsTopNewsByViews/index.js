...
export function EnterpriseExportGenericGraphsTopNewsByViews(props) {
  ...
  return (
    <Box display='flex' alignItems='center' width='auto'>
      ...
      <Box order={2}>
        {' exported top news by views graph via CSV '}
        {' at '}
...
EnterpriseExportGenericGraphsTopNewsByViews.propTypes = {
  activity: PropTypes.object,
};

export default compose(
  memo,
)(EnterpriseExportGenericGraphsTopNewsByViews);

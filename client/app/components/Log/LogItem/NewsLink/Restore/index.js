...
export function NewsLinkRestore(props) {
        ...
        { activity.trackable ? (
          <React.Fragment>
            <Link
              ...
              to={ROUTES.group.news.news_links.show.path(activity.trackable.group_id, activity.trackable.news_feed_link_id)}
            >

...
export function GroupExportSubGroupsMembersList(props) {
  ...
  return (
    <React.Fragment>
      ...
      {' exported sub-group members list via CSV of group '}
      { activity.trackable ? (
        <React.Fragment>
          <Link
...
GroupExportSubGroupsMembersList.propTypes = {
  activity: PropTypes.object,
};

export default compose(
  memo,
)(GroupExportSubGroupsMembersList);

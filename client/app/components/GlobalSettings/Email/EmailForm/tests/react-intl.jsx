...
// eslint-disable-next-line react/react-in-jsx-scope
Intl.FormattedDate = props => <IntlProvider {...defaultProps}><FormattedDate {...props} /></IntlProvider>;
// eslint-disable-next-line react/react-in-jsx-scope
Intl.FormattedTime = props => <IntlProvider {...defaultProps}><FormattedTime {...props} /></IntlProvider>;
// eslint-disable-next-line react/react-in-jsx-scope
Intl.FormattedRelative = props => <IntlProvider {...defaultProps}><FormattedRelative {...props} /></IntlProvider>;
// eslint-disable-next-line react/react-in-jsx-scope
Intl.FormattedNumber = props => <IntlProvider {...defaultProps}><FormattedNumber {...props} /></IntlProvider>;
// eslint-disable-next-line react/react-in-jsx-scope
Intl.FormattedPlural = props => <IntlProvider {...defaultProps}><FormattedPlural {...props} /></IntlProvider>;
// eslint-disable-next-line react/react-in-jsx-scope
Intl.FormattedMessage = props => <IntlProvider {...defaultProps}><FormattedMessage {...props} /></IntlProvider>;
// eslint-disable-next-line react/react-in-jsx-scope
Intl.FormattedHTMLMessage = props => <IntlProvider {...defaultProps}><FormattedHTMLMessage {...props} /></IntlProvider>;

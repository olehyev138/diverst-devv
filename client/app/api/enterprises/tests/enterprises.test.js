...
describe('Enterprise API Calls', () => {
  ...
  it('calls GET function', async () => {
    ...
    expect(mockAxios.get).toHaveBeenCalledWith('/api/v1/enterprises?page=1&count=10&order=desc&orderBy=enterprises.created_at');
  });
  ...
  it('calls GET function', async () => {
    ...
    expect(page).toEqual(response);
    expect(mockAxios.get).toHaveBeenCalledTimes(1);
    expect(mockAxios.get).toHaveBeenCalledWith('/api/v1/enterprises/1');
  });
  ...
  it('calls POST function', async () => {
    ...
    expect(mockAxios.post).toHaveBeenCalledWith('/api/v1/enterprises', {});
  });
  ...
  it('calls PUT function', async () => {
    ...
    expect(mockAxios.put).toHaveBeenCalledWith('/api/v1/enterprises/1', {});
  });
  ...
  it('calls DELETE function', async () => {
    ...
    expect(mockAxios.delete).toHaveBeenCalledWith('/api/v1/enterprises/1');
  });
  ...
  it('calls POST function', async () => {
    ...
    expect(page).toEqual(response);
    expect(mockAxios.post).toHaveBeenCalledTimes(1);
    expect(mockAxios.post).toHaveBeenCalledWith('/api/v1/enterprises/1/sso_link', {});
  });
});

module Group::Actions
  ...
  module ClassMethods
    ...
    def base_preloads
      [ :news_feed, :children, :enterprise, :logo_attachment, :banner_attachment, enterprise: [ :theme ], children: base_preload_no_recursion ]
    end
    ...
    def base_attributes_preloads
      [ :news_feed, :logo_attachment, :banner_attachment, enterprise: [ :theme ] ]
    end
  end
end

class Initiative < BaseClass
  ...
  scope :all_upcoming_events_for_group, ->(group_id) { group = Group.find(group_id); group.initiatives.upcoming.limit(3) + group.participating_initiatives.upcoming.limit(3)  }

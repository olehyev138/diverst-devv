module ApplicationHelper
  ...
  def manage_erg_budgets_path
    ...
    return group_initiatives_path(@group || policy_scope(Group).first) if policy(Initiative).index?
    return metrics_group_path(@group || policy_scope(Group).first) if current_user.policy_group.groups_manage?

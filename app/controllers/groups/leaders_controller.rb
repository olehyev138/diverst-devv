class Groups::LeadersController < ApplicationController
  ...
  def group_params
    ...
    .permit(group_leaders_attributes:
      [:id, :position, :user_id, :position_name, :user_role_id, :_destroy, :visible, :pending_member_notifications_enabled,
       :pending_comments_notifications_enabled, :pending_posts_notifications_enabled, :default_group_contact])
  end
end

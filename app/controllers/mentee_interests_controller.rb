class MenteeInterestsController < ApplicationController
  ...
  def index
    ...
    @topics = current_user.enterprise.mentee_interests
  end

  def new
    authorize MentoringInterest
    @topic = current_user.enterprise.mentee_interests.new
  end

  def create
    authorize MentoringInterest
    @topic = current_user.enterprise.mentee_interests.new(topic_params)
  ...
  def set_topic
    @topic = current_user.enterprise.mentee_interests.find(params[:id])
  end

  def topic_params
    params
      .require(:mentee_interest)
      .permit(
        :name
      )
  end

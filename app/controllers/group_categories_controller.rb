class GroupCategoriesController < ApplicationController
  ...
  def update_all_groups
    ...
    params[:children].each do |child|
      ...
      Group.find(child[0].to_i).update(group_category_id: child[1][:group_category_id].to_i, group_category_type_id: @group_category_id.nil? ? nil : GroupCategory.find(@group_category_id).group_category_type_id
 )
    end

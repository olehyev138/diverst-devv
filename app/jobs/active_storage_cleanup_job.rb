class ActiveStorageCleanupJob < ActiveJob::Base
  ...
  # @note blob_lifetime should stay default most of the time. This option is primarily for development to purge unnecessary files
  def perform(blob_lifetime = 240.minutes, batch_size = 500)

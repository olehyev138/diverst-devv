class GenericGraphsTopGroupsByViewsDownloadJob < ActiveJob::Base
    ...
    def perform(user_id, enterprise_id, erg_text, demo)
        ...
        csv = demo ? enterprise.generic_graphs_demo_top_groups_by_views_csv(erg_text) : enterprise.generic_graphs_non_demo_top_groups_by_views_csv(erg_text)

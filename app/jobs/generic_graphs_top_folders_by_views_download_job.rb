class GenericGraphsTopFoldersByViewsDownloadJob < ActiveJob::Base
    ...
    def perform(user_id, enterprise_id, demo)
        ...
        csv = demo ? enterprise.generic_graphs_demo_top_folders_by_views_csv : enterprise.generic_graphs_non_demo_top_folders_by_views_csv

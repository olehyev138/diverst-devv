module BasePager
  ...
  module ClassMethods
    ...
    def pager(diverst_request, params = {}, search_method = :lookup, base: self, policy: nil, action: :index)
      ...
      # search
      partial_query = search_method_obj.call(params, diverst_request, base: base, policy: policy, action: action)
      if sum_column

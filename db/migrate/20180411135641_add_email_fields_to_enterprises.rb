class AddEmailFieldsToEnterprises < ActiveRecord::Migration
  def change
    ...
    add_column :enterprises, :budget_declined_mailer_notification_text, :text
    add_column :enterprises, :group_leader_post_mailer_notification_text, :text

  ...
  def up
    ...
    Enterprise.find_each do |enterprise|
      ...
      enterprise.user_roles.create!(
        [
          {:role_name => "admin",                 :role_type => "admin", :priority => 1},
          {:role_name => "diversity_manager",     :role_type => "admin", :priority => 2},
          {:role_name => "national_manager",      :role_type => "admin", :priority => 3},
          {:role_name => "group_leader",          :role_type => "group", :priority => 4},
          {:role_name => "group_treasurer",       :role_type => "group", :priority => 5},
          {:role_name => "group_content_creator", :role_type => "group", :priority => 6},
          {:role_name => "user",                  :role_type => "user", :default => true, :priority => 7}
        ]
      )

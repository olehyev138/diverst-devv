...
ActiveRecord::Schema.define(version: 2020_12_01_183045) do
  ...
  create_trigger("budgets_after_insert_row_tr", :generated => true, :compatibility => 1).
      on("budgets").
      after(:insert) do
    "SET @budget_id = -1; SET @annual_budget_id = -1; SELECT `budgets`.`id`, `budgets`.`annual_budget_id` FROM `budgets` WHERE (`budgets`.`id` = NEW.`id`) INTO @budget_id, @annual_budget_id; SET @old_spent = 0; SET @old_reserved = 0; SET @old_user_estimates = 0; SET @old_finalized_expenditures = 0; SET @old_requested_amount = 0; SELECT IFNULL(spent, 0), IFNULL(reserved, 0), IFNULL(user_estimates, 0), IFNULL(finalized_expenditures, 0), IFNULL(requested_amount, 0) FROM `budgets_sums` WHERE (`budget_id` = @budget_id) INTO @old_spent, @old_reserved, @old_user_estimates, @old_finalized_expenditures, @old_requested_amount; SET @requested = (SELECT requested FROM `budgets_with_expenses` WHERE `id` = NEW.`id`); SET @new_requested = @old_requested + @requested; SET @new_spent = @old_spent; SET @new_reserved = @old_reserved; SET @new_user_estimates = @old_user_estimates; SET @new_finalized_expenditures = @old_finalized_expenditures; SET @new_requested_amount = @old_requested_amount; REPLACE INTO budgets_sums VALUES(@budget_id, IFNULL(@new_spent, 0), IFNULL(@new_reserved, 0), IFNULL(@new_user_estimates, 0), IFNULL(@new_finalized_expenditures, 0), IFNULL(@new_requested_amount, 0)); SET @old_spent = 0; SET @old_reserved = 0; SET @old_user_estimates = 0; SET @old_finalized_expenditures = 0; SET @old_requested_amount = 0; SET @old_approved = 0; SELECT IFNULL(spent, 0), IFNULL(reserved, 0), IFNULL(user_estimates, 0), IFNULL(finalized_expenditures, 0), IFNULL(requested_amount, 0), IFNULL(approved, 0) FROM `annual_budgets_sums` WHERE (`annual_budget_id` = @annual_budget_id) INTO @old_spent, @old_reserved, @old_user_estimates, @old_finalized_expenditures, @old_requested_amount, @old_approved; SET @requested = (SELECT requested FROM `budgets_with_expenses` WHERE `id` = NEW.`id`); SET @new_requested = @old_requested + @requested; SET @new_spent = @old_spent; SET @new_reserved = @old_reserved; SET @new_user_estimates = @old_user_estimates; SET @new_finalized_expenditures = @old_finalized_expenditures; SET @new_requested_amount = @old_requested_amount; SET @new_approved = @old_approved; REPLACE INTO annual_budgets_sums VALUES(@annual_budget_id, IFNULL(@new_spent, 0), IFNULL(@new_reserved, 0), IFNULL(@new_user_estimates, 0), IFNULL(@new_finalized_expenditures, 0), IFNULL(@new_requested_amount, 0), IFNULL(@new_approved, 0));"
  end

  create_trigger("budgets_before_delete_row_tr", :generated => true, :compatibility => 1).
      on("budgets").
      before(:delete) do
    "SET @budget_id = -1; SET @annual_budget_id = -1; SELECT `budgets`.`id`, `budgets`.`annual_budget_id` FROM `budgets` WHERE (`budgets`.`id` = OLD.`id`) INTO @budget_id, @annual_budget_id; SET @old_spent = 0; SET @old_reserved = 0; SET @old_user_estimates = 0; SET @old_finalized_expenditures = 0; SET @old_requested_amount = 0; SELECT IFNULL(spent, 0), IFNULL(reserved, 0), IFNULL(user_estimates, 0), IFNULL(finalized_expenditures, 0), IFNULL(requested_amount, 0) FROM `budgets_sums` WHERE (`budget_id` = @budget_id) INTO @old_spent, @old_reserved, @old_user_estimates, @old_finalized_expenditures, @old_requested_amount; SET @requested = (SELECT requested FROM `budgets_with_expenses` WHERE `id` = OLD.`id`); SET @new_requested = @old_requested - @requested; SET @new_spent = @old_spent; SET @new_reserved = @old_reserved; SET @new_user_estimates = @old_user_estimates; SET @new_finalized_expenditures = @old_finalized_expenditures; SET @new_requested_amount = @old_requested_amount; REPLACE INTO budgets_sums VALUES(@budget_id, IFNULL(@new_spent, 0), IFNULL(@new_reserved, 0), IFNULL(@new_user_estimates, 0), IFNULL(@new_finalized_expenditures, 0), IFNULL(@new_requested_amount, 0)); SET @old_spent = 0; SET @old_reserved = 0; SET @old_user_estimates = 0; SET @old_finalized_expenditures = 0; SET @old_requested_amount = 0; SET @old_approved = 0; SELECT IFNULL(spent, 0), IFNULL(reserved, 0), IFNULL(user_estimates, 0), IFNULL(finalized_expenditures, 0), IFNULL(requested_amount, 0), IFNULL(approved, 0) FROM `annual_budgets_sums` WHERE (`annual_budget_id` = @annual_budget_id) INTO @old_spent, @old_reserved, @old_user_estimates, @old_finalized_expenditures, @old_requested_amount, @old_approved; SET @requested = (SELECT requested FROM `budgets_with_expenses` WHERE `id` = OLD.`id`); SET @new_requested = @old_requested - @requested; SET @new_spent = @old_spent; SET @new_reserved = @old_reserved; SET @new_user_estimates = @old_user_estimates; SET @new_finalized_expenditures = @old_finalized_expenditures; SET @new_requested_amount = @old_requested_amount; SET @new_approved = @old_approved; REPLACE INTO annual_budgets_sums VALUES(@annual_budget_id, IFNULL(@new_spent, 0), IFNULL(@new_reserved, 0), IFNULL(@new_user_estimates, 0), IFNULL(@new_finalized_expenditures, 0), IFNULL(@new_requested_amount, 0), IFNULL(@new_approved, 0));"
  end
  ...
  create_trigger("budget_users_after_update_of_estimated_row_tr", :generated => true, :compatibility => 1).
      ...
      after(:update).
      of(:estimated) do
    "SET @budget_item_id = -1; SET @budget_id = -1; SET @annual_budget_id = -1; SELECT `budget_items`.`id`, `budget_items`.`budget_id`, `budgets`.`annual_budget_id` FROM `budget_items` INNER JOIN `budgets` ON `budgets`.`id` = `budget_items`.`budget_id` WHERE (`budget_items`.`id` = NEW.`budget_item_id`) INTO @budget_item_id, @budget_id, @annual_budget_id; SET @old_spent = 0; SET @old_reserved = 0; SET @old_user_estimates = 0; SET @old_finalized_expenditures = 0; SELECT IFNULL(spent, 0), IFNULL(reserved, 0), IFNULL(user_estimates, 0), IFNULL(finalized_expenditures, 0) FROM `budget_items_sums` WHERE (`budget_item_id` = @budget_item_id) INTO @old_spent, @old_reserved, @old_user_estimates, @old_finalized_expenditures; SET @new_reserved = @old_reserved + NEW.estimated - OLD.estimated; SET @new_user_estimates = @old_user_estimates + NEW.estimated - OLD.estimated; SET @new_spent = @old_spent; SET @new_user_estimates = @old_user_estimates; SET @new_finalized_expenditures = @old_finalized_expenditures; REPLACE INTO budget_items_sums VALUES(@budget_item_id, IFNULL(@new_spent, 0), IFNULL(@new_reserved, 0), IFNULL(@new_user_estimates, 0), IFNULL(@new_finalized_expenditures, 0)); SET @old_spent = 0; SET @old_reserved = 0; SET @old_user_estimates = 0; SET @old_finalized_expenditures = 0; SET @old_requested_amount = 0; SELECT IFNULL(spent, 0), IFNULL(reserved, 0), IFNULL(user_estimates, 0), IFNULL(finalized_expenditures, 0), IFNULL(requested_amount, 0) FROM `budgets_sums` WHERE (`budget_id` = @budget_id) INTO @old_spent, @old_reserved, @old_user_estimates, @old_finalized_expenditures, @old_requested_amount; SET @new_reserved = @old_reserved + NEW.estimated - OLD.estimated; SET @new_user_estimates = @old_user_estimates + NEW.estimated - OLD.estimated; SET @new_spent = @old_spent; SET @new_user_estimates = @old_user_estimates; SET @new_finalized_expenditures = @old_finalized_expenditures; SET @new_requested_amount = @old_requested_amount; REPLACE INTO budgets_sums VALUES(@budget_id, IFNULL(@new_spent, 0), IFNULL(@new_reserved, 0), IFNULL(@new_user_estimates, 0), IFNULL(@new_finalized_expenditures, 0), IFNULL(@new_requested_amount, 0)); SET @old_spent = 0; SET @old_reserved = 0; SET @old_user_estimates = 0; SET @old_finalized_expenditures = 0; SET @old_requested_amount = 0; SET @old_approved = 0; SELECT IFNULL(spent, 0), IFNULL(reserved, 0), IFNULL(user_estimates, 0), IFNULL(finalized_expenditures, 0), IFNULL(requested_amount, 0), IFNULL(approved, 0) FROM `annual_budgets_sums` WHERE (`annual_budget_id` = @annual_budget_id) INTO @old_spent, @old_reserved, @old_user_estimates, @old_finalized_expenditures, @old_requested_amount, @old_approved; SET @new_reserved = @old_reserved + NEW.estimated - OLD.estimated; SET @new_user_estimates = @old_user_estimates + NEW.estimated - OLD.estimated; SET @new_spent = @old_spent; SET @new_user_estimates = @old_user_estimates; SET @new_finalized_expenditures = @old_finalized_expenditures; SET @new_requested_amount = @old_requested_amount; SET @new_approved = @old_approved; REPLACE INTO annual_budgets_sums VALUES(@annual_budget_id, IFNULL(@new_spent, 0), IFNULL(@new_reserved, 0), IFNULL(@new_user_estimates, 0), IFNULL(@new_finalized_expenditures, 0), IFNULL(@new_requested_amount, 0), IFNULL(@new_approved, 0));"
  end
  ...
  create_trigger("budget_users_after_update_of_finished_expenses_row_tr", :generated => true, :compatibility => 1).
    ...
    "SET @budget_item_id = -1; SET @budget_id = -1; SET @annual_budget_id = -1; SELECT `budget_items`.`id`, `budget_items`.`budget_id`, `budgets`.`annual_budget_id` FROM `budget_items` INNER JOIN `budgets` ON `budgets`.`id` = `budget_items`.`budget_id` WHERE (`budget_items`.`id` = NEW.`budget_item_id`) INTO @budget_item_id, @budget_id, @annual_budget_id; SET @old_spent = 0; SET @old_reserved = 0; SET @old_user_estimates = 0; SET @old_finalized_expenditures = 0; SELECT IFNULL(spent, 0), IFNULL(reserved, 0), IFNULL(user_estimates, 0), IFNULL(finalized_expenditures, 0) FROM `budget_items_sums` WHERE (`budget_item_id` = @budget_item_id) INTO @old_spent, @old_reserved, @old_user_estimates, @old_finalized_expenditures; SET @spent = (SELECT spent FROM `budget_users_with_expenses` WHERE `id` = OLD.`id`); IF COALESCE(OLD.`finished_expenses`, FALSE) AND NOT COALESCE(NEW.`finished_expenses`, FALSE) THEN SET @new_reserved = @old_reserved + OLD.`estimated` - @spent; SET @new_finalized_expenditures = @old_finalized_expenditures - @spent; ELSEIF NOT COALESCE(OLD.`finished_expenses`, FALSE) AND COALESCE(NEW.`finished_expenses`, FALSE) THEN SET @new_reserved = @old_reserved - OLD.`estimated` + @spent; SET @new_finalized_expenditures = @old_finalized_expenditures + @spent; END IF; SET @new_spent = @old_spent; SET @new_user_estimates = @old_user_estimates; REPLACE INTO budget_items_sums VALUES(@budget_item_id, IFNULL(@new_spent, 0), IFNULL(@new_reserved, 0), IFNULL(@new_user_estimates, 0), IFNULL(@new_finalized_expenditures, 0)); SET @old_spent = 0; SET @old_reserved = 0; SET @old_user_estimates = 0; SET @old_finalized_expenditures = 0; SET @old_requested_amount = 0; SELECT IFNULL(spent, 0), IFNULL(reserved, 0), IFNULL(user_estimates, 0), IFNULL(finalized_expenditures, 0), IFNULL(requested_amount, 0) FROM `budgets_sums` WHERE (`budget_id` = @budget_id) INTO @old_spent, @old_reserved, @old_user_estimates, @old_finalized_expenditures, @old_requested_amount; SET @spent = (SELECT spent FROM `budget_users_with_expenses` WHERE `id` = OLD.`id`); IF COALESCE(OLD.`finished_expenses`, FALSE) AND NOT COALESCE(NEW.`finished_expenses`, FALSE) THEN SET @new_reserved = @old_reserved + OLD.`estimated` - @spent; SET @new_finalized_expenditures = @old_finalized_expenditures - @spent; ELSEIF NOT COALESCE(OLD.`finished_expenses`, FALSE) AND COALESCE(NEW.`finished_expenses`, FALSE) THEN SET @new_reserved = @old_reserved - OLD.`estimated` + @spent; SET @new_finalized_expenditures = @old_finalized_expenditures + @spent; END IF; SET @new_spent = @old_spent; SET @new_user_estimates = @old_user_estimates; SET @new_requested_amount = @old_requested_amount; REPLACE INTO budgets_sums VALUES(@budget_id, IFNULL(@new_spent, 0), IFNULL(@new_reserved, 0), IFNULL(@new_user_estimates, 0), IFNULL(@new_finalized_expenditures, 0), IFNULL(@new_requested_amount, 0)); SET @old_spent = 0; SET @old_reserved = 0; SET @old_user_estimates = 0; SET @old_finalized_expenditures = 0; SET @old_requested_amount = 0; SET @old_approved = 0; SELECT IFNULL(spent, 0), IFNULL(reserved, 0), IFNULL(user_estimates, 0), IFNULL(finalized_expenditures, 0), IFNULL(requested_amount, 0), IFNULL(approved, 0) FROM `annual_budgets_sums` WHERE (`annual_budget_id` = @annual_budget_id) INTO @old_spent, @old_reserved, @old_user_estimates, @old_finalized_expenditures, @old_requested_amount, @old_approved; SET @spent = (SELECT spent FROM `budget_users_with_expenses` WHERE `id` = OLD.`id`); IF COALESCE(OLD.`finished_expenses`, FALSE) AND NOT COALESCE(NEW.`finished_expenses`, FALSE) THEN SET @new_reserved = @old_reserved + OLD.`estimated` - @spent; SET @new_finalized_expenditures = @old_finalized_expenditures - @spent; ELSEIF NOT COALESCE(OLD.`finished_expenses`, FALSE) AND COALESCE(NEW.`finished_expenses`, FALSE) THEN SET @new_reserved = @old_reserved - OLD.`estimated` + @spent; SET @new_finalized_expenditures = @old_finalized_expenditures + @spent; END IF; SET @new_spent = @old_spent; SET @new_user_estimates = @old_user_estimates; SET @new_requested_amount = @old_requested_amount; SET @new_approved = @old_approved; REPLACE INTO annual_budgets_sums VALUES(@annual_budget_id, IFNULL(@new_spent, 0), IFNULL(@new_reserved, 0), IFNULL(@new_user_estimates, 0), IFNULL(@new_finalized_expenditures, 0), IFNULL(@new_requested_amount, 0), IFNULL(@new_approved, 0));"
  end

...
ActiveRecord::Schema.define(version: 20_160_125_215_139) do
  ...
  create_table 'emails', force: :cascade do |t|
    ...
    t.text     'custom_html_template', limit: 65_535
    t.text     'custom_txt_template',  limit: 65_535
    t.integer  'enterprise_id',        limit: 4
    t.datetime 'created_at',                         null: false
    t.datetime 'updated_at',                         null: false
  end
  ...
  create_table 'fields', force: :cascade do |t|
    ...
    t.text     'options_text',       limit: 65_535
  ...
  add_index 'fields', %w(container_type container_id), name: 'index_fields_on_container_type_and_container_id', using: :btree
  ...
  add_index 'graphs', %w(collection_type collection_id), name: 'index_graphs_on_collection_type_and_collection_id', using: :btree
  ...
  create_table 'questions', force: :cascade do |t|
    ...
    t.text     'conclusion', limit: 65_535
  end
  ...
  add_index 'resources', %w(container_type container_id), name: 'index_resources_on_container_type_and_container_id', using: :btree

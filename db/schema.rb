...
ActiveRecord::Schema.define(version: 2019_05_23_222507) do
  ...
  create_table "segment_rules", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "segment_id"
    t.integer "field_id"
    t.integer "operator"
    t.text "values"

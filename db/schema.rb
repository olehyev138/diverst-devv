...
ActiveRecord::Schema.define(version: 2020_03_23_063309) do
  ...
  create_table "annual_budgets", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "group_id"
  ...
  create_table "page_names", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "page_url"
    t.string "page_name"
  ...
  create_table "page_visitation_data", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.integer "user_id"
    t.string "page_url"
    t.string "controller"
    t.string "action"
  ...
  create_table "updates", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.text "data"
    t.text "comments"
    t.date "report_date"
    t.bigint "owner_id"
